...
@section('container')
    ...
    @if(auth()->user() && auth()->user()->role === 'admin')
        <div class="row row-sm">
            ...
            <div class="bg-purple rounded overflow-hidden">
                ...
                <div class="mg-l-20">
                    @if(auth()->user() && auth()->user()->role === 'admin')
                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Total Cars</p>
                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">
            ...
            <div class="bg-teal rounded overflow-hidden">
                ...
                <div class="mg-l-20">
                    @if(auth()->user() && auth()->user()->role === 'admin')
                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Cars toatal Cost</p>
                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">
                        {{ \App\Models\Rental::sum('total_cost') }}
                        </p>
                    @endif
                </div>
                </div>
            ...
            <div class="bg-primary rounded overflow-hidden">
                ...
                <div class="mg-l-20">
                    @if(auth()->user() && auth()->user()->role === 'admin')
                        <p class="tx-10 tx-spacing-1 tx-mont tx-semibold tx-uppercase tx-white-8 mg-b-10">Available Cars</p>
                        <p class="tx-24 tx-white tx-lato tx-bold mg-b-0 lh-1">
                            {{ \App\Models\Car::where('availability', 1)->count() }}
                        </p>
                    @endif
                </div>
                </div>
    ...
    @if( auth()->user() && auth()->user()->role === 'user')
        <div class="row mg-t-20">
            <div class="col-md-12">
                <div class="card bd-0 shadow-base bg-teal">
                
                    <h1 class="text-center pt-5 text-white">Any Kind Of Update and <br> Notification are showing here</h1>
